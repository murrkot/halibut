...
public class DeleteUserConfirmationPanel extends DialogBox {
    ...
    public DeleteUserConfirmationPanel(String username, ConfirmHandler confirmHandler) {
        super(true, true);
        ...
        Label message = new Label("Delete user '" + safe(username) + "'? This action cannot be undone.");
        root.add(message);
