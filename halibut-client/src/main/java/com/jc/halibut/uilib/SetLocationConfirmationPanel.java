...
public class SetLocationConfirmationPanel extends DialogBox {
    ...
    public SetLocationConfirmationPanel(String locationName, ConfirmHandler confirmHandler) {
        super(true, true);
        setText("Confirm Location");
        ...
        Label message = new Label("Set current location to '" + safe(locationName) + "'?");
        root.add(message);
